...
// this class is similar to the groupChatModal however it's goal is handle change such removing or adding users and renaming 
          ...
          <ModalBody display="flex" flexDir="column" alignItems="center">
            ...
            <FormControl>
              ...
              />
                ...
                {/* spin animation while searching users to add */}
            {loading ? (
              <Spinner size="lg" />
            ) : (
...
// if not working make sure to check api Routes 